...
class TypeAService extends BaseService {
    getFormItems() {
        return [
            ...
            { name: '设备功能', field: 'device_funciton', datatype: 'string', type: 'text-media', css: 'long-col' },
            { name: '正常状态', field: 'normal_status', datatype: 'string', type: 'switch', defaultValue: '开', values: ['关', '开'] },
            ...
            { name: '可能的人误点', field: 'human_error_factor', datatype: 'string', type: 'text-media', css: 'long-col' },
            { name: '人误失误模式', field: 'human_error_pattern', datatype: 'string', type: 'text-media', css: 'long-col' },
            { name: '人误描述', field: 'human_error_desc', datatype: 'string', type: 'text-media', css: 'long-col' },
            { name: '筛选原因', field: 'filter_reason', datatype: 'string', type: 'text-media', css: 'long-col' },
            { name: '筛选依据', field: 'filter_by', datatype: 'string', type: 'text-media', css: 'long-col' },
            { name: '筛选结果', field: 'filter_results', datatype: 'string', type: 'text-media', css: 'long-col' },
            { name: '成功准则', field: 'success_criteria', datatype: 'string', type: 'text-media', css: 'long-col' },
