            ...
            },
            {
                ...
                options: [{
                        ...
                        options: [
                            ...
                            },
                            {
                                ...
                                options: [
                                    ...
                                    { name: '优先级：未能正确平衡优先级别', code: 'T3-01-03-04' },
                                    { name: '其他（详细说明）：', code: 'T3-01-03-05' }
                                ],
                                code: 'T3-01-03'
                            }
                        ]
                    },
                    {
                        ...
                        name: '相关的规程导则不可用',
                        options: [
                            { name: '全面性：未能考虑所有的选择', code: 'T3-02-01' },
                            { name: '选择：作出错误的选择', code: 'T3-02-02' },
                    ...
                    },
                    {
                        ...
                        options: [
                            { name: '指令沟通：班组设置或沟通指令不充分', code: 'T5-02-01' },
                            {
                                ...
                                code: 'T5-02-02',
                                options: [
                                    { name: '积极响应：所有成员未积极响应', code: 'T5-02-02-01' },
                                    { name: '质疑态度：不鼓励质疑的态度', code: 'T5-02-02-02' },
                                    { name: '团队角色：未形成团队角色的理解', code: 'T5-02-03-03' },
                                    { name: '民意测验：未提供机会获得其他人员的输入', code: 'T5-02-02-04' }
                                ]
                            },
                            { name: '优先级错误：优先级错误（最重要事项排第一）', code: 'T5-02-03' },
                            { name: '分配问题：任务分配失败', code: 'T5-02-05' },
                            { name: '太被动：保持一种被动态度而不是主动态度', code: 'T5-02-05' },
                            { name: '班组负荷问题：未有效的使用资源', code: 'T5-02-06' }
                        ]
                    },
