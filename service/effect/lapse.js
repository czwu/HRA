    ...
    getLapseOptions() {
        let options = [{
            ...
            },
            {
                ...
                options: [
                    { group: 'T6', name: '协调性差：未能协调好精力，如协调由于电厂操纵员汽轮机降负荷太快反应堆操纵员未能支持的问题', code: 'T6-01' },
                    { group: 'T6', name: '缺乏归属意识：缺乏已定义好的角色或责任导致缺乏归属意识', code: 'T6-02' },
                    { group: 'T6', name: '主题归类：操纵员未告知其他人员操作的影响', code: 'T6-03' },
                    { group: 'T6', name: '缺乏共同的理解：缺乏共同的理解和指导', code: 'T6-04' },
                    { group: 'T6', name: '人员冲突：相互之间不尊重或未解决人员冲突', code: 'T6-05' },
                    { group: 'T6', name: '概括性/包含性差：部分班组成员起支配作用，而其他人不愿意提供输入', code: 'T6-06' },
                    {
                        name: '简报遗漏或不完全',
                        code: 'T6-07',
                        group: 'T6',
