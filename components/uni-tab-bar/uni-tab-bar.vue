<template>
  <view class="tab-bar" v-show="type != 'base' ">
    <view class="tab-bar-warp uni-grow">
      <view class="uni-grow" style="flex-grow:2;height:0px"></view>
      <view
        ...
        @click="tabClick(item)"
      >
        <view class="tab-bar-icon" :class=" key == index ? item.icon+ ' active' : item.icon "></view>
        <text class="tab-bar-text">{{item.text}}</text>
      </view>
      
      <view class="uni-grow" style="flex-grow:2;height:0px"></view>
      <!-- <view class="center" @click="goCenter" :class="{active:type == 'base'}"></view> -->
    </view>
  </view>
</template>
